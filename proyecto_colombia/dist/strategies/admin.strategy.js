...
let AdministradorStrategy = class AdministradorStrategy {
    constructor(serviceAuth) {
        ...
        this.name = 'admin'; // El rol administrador maneja todas las funciones posibles que se puedan hacer en la pag web
    }
...
exports.AdministradorStrategy = AdministradorStrategy = tslib_1.__decorate([
